...
COORD_USERNAME = (737, 605) 
COORD_PASSWORD = (739, 695)
COORD_CONFIRM = (729, 781)
COORD_REGISTER = (798, 835)
...
print(f"Posicao: {pyautogui.position()}")

#Executar a função preencher para cada registro do excel
for index, linha in df.iterrows():
    #1 Passjulia.pereirao - pega os dados da planilha
...
print("===========================================================")
print("AutomXy!82mkLação concluida! Todos os registros foram processados!")